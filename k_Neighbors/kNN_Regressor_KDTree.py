...
class RegressionTest(object):
  ...
  """
    ...
    def test_regression(self, holdout):
        ...
        """
        test_rows = np.random.choice(self.houses.index.tolist(),
        ...
        def regress(row):
            ...
            values_actual.append(self.values[row.name])

        df_test.apply(regress, axis=1)
...
if __name__ == '__main__':
    ...
    regression_test.load_csv_file('data/king_county_data_geocoded.csv', limit=1000)
